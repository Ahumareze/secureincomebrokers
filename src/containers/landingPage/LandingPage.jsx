...
import { About, Coursel, NewTransaction, PlansUpdate, Services, Stats, Team, Transactions, Video, VideoModal } from './components';
...
function LandingPage() {
    ...
    return (
        <div className={classes.container}>
            ...
            {showModal && <NewTransaction name={currentItem.name} amount={currentItem.amount} />}
        </div>
    )
}
