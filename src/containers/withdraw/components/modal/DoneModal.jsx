        ...
        <div className={classes.backdrop}>
            <div className={classes.backdrop_main}>
                ...
                <div className={classes.done_container}>
                    ...
                    <p className={classes.done_title}>Withdrawal placed successfuly 🎉</p>
                    <p className={classes.done_main}>Your withdrawal request has been placed and our admins will be notified</p>
                </div>
